...
public class Bai3Fragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        attractions.add(new Attraction("Bãi Biển Nha Trang", "Phường Vĩnh Phương, Nha Trang", R.drawable.bai_bien_nha_trang));
        attractions.add(new Attraction("Vinpearl Amusement Park", "Đảo Hòn Tre, Nha Trang", R.drawable.winpeal_nha_trang));
